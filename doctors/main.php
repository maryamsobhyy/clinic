<?php $id=$_GET['id'];
 ...
 if(($id)){
    $doctors=$db->getData("doctors", "id,name,bio", "major_id = $id");
 }
 else{
            ...
            <div class="doctors-grid">
                ...
                <div class="card p-2" style="width: 18rem;">
                    ...
                    <div class="card-body d-flex flex-column gap-1 justify-content-center">
                        ...
                        <h6 class="card-title fw-bold text-center"><?php echo $doctor['bio'] ?></h6>
                        <a href="./doctor.php?id=<?php echo $doctor['id'];?>" class="btn btn-outline-primary card-button">Book an
                            appointment</a>
                    </div>
                    <?php endforeach;?>
                 </div>
