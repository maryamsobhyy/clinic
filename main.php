...
function getdoctor(){
    ...
    $sql="SELECT majors.title, doctors.name
    FROM majors
    JOIN doctors ON majors.id = doctors.major_id";
    $data = $con->query($sql);
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
                    <div class="d-flex gap-3 flex-wrap justify-content-center" role="group">
                        <a type="button" class="btn btn-outline-light navigation--button" href="./main.php">Home</a>
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="./majors.php">majors</a>
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="./main.php">Doctors</a>
                        <a type="button" class="btn btn-outline-light navigation--button" href="./login.php">login</a>
                        <a type="button" class="btn btn-outline-light navigation--button"
                            href="./loginadmin.php">Dashboard</a>
                    </div>
                </div>
            </div>
        </nav>
            ...
            <?php foreach($doctors as $doctor)  : 
                ...
                <div class="card p-2" style="width: 18rem;">
                    ...
                    <h4 class="card-title fw-bold text-center"><?php echo $doctor['name']?></h4>
                                    ...
                                    <a href="./majors.php" class="btn btn-outline-primary card-button"> To Book an
                                        appointment open majors section then booking</a>
        ...
        <div class="row gap-2">
            ...
            <div class="col-sm order-sm-2">
                ...
                <div class="links d-flex gap-2 flex-wrap">
                    <a href="./main.php" class="link text-white">Home</a>
                    <a href="./majors.php" class="link text-white">Majors</a>
                    <a href="./doctors/main.php" class="link text-white">Doctors</a>
